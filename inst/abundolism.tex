...
10,000 simulations were run, each with a unique set of randomly sampled
parameters.
...
$\lambda$ & (\texttt{la}) & 1.0 & 10.000 & local birth rate\\
$\mu$ & (\texttt{mu}) & 1.0 & 10.000 & local death rate\\
...
\addlinespace
$\tau$ & (\texttt{tau}) & 0.0 & 4.000 & wait time to full speciation in the absence of dispersal\\
$\xi$ & (\texttt{xi}) & 0.5 & 2.000 & amount each dispersal event sets back the progression toward speciation\\
